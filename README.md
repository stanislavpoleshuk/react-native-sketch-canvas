...
```bash
npm install https://github.com/stanislavpoleshuk/react-native-sketch-canvas.git --save
```
Link native code
```bash
react-native link https://github.com/stanislavpoleshuk/react-native-sketch-canvas.git
```
